...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 py-20 p-20 font-founder">
      <div className="w-1/2  h-full flex flex-col justify-between">
        <div className="headding">
          <h1 className="text-[8vw] tracking-tighter font-semibold uppercase leading-none -mb-10">
            Eye-
          </h1>
          <h1 className="text-[8vw] tracking-tighter font-semibold uppercase leading-none -mb-10">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[5.5vw] tracking-tighter font-semibold uppercase">
          PRESENTATIONS
        </h1>
        <div className="dets font-['Neue_Montreal']">
          {["Facebook", "Instagram", "Twitter"].map((item, index) => (
            <a className="block text-xl font-light" href="" key={index}>
              {item}
            </a>
          ))}
        </div>
